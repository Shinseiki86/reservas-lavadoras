	...
	<table class="table table-striped" id="tabla">
		...
		<tbody>
			...
			<tr>
				...
				{{--<td>
					<i class="fas fa-address-card-o" aria-hidden="true" data-tooltip="tooltip" data-placement="bottom" data-container="body" title="{{ $rol -> permissions ->implode('display_name', ', ') }}"></i>
				</td>--}}
